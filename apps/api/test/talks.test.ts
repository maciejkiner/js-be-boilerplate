...
// The scaffolder could not seed these required relations automatically: eventId, roomId.
// Add the prerequisite records in create() and set RELATIONS_TODO = false to enable the test.
const RELATIONS_TODO: boolean = true;

/** CRUD for the talks entity — generated by the scaffolder. */
describe.skipIf(!url || RELATIONS_TODO)("talks CRUD (generated)", () => {
  ...
  async function create() {
    ...
    const eventId = "";
    // TODO: create a `room` record (a required relation) and use its id.
    const roomId = "";
    return app.inject({
      method: "POST",
      url: "/api/v1/talks",
